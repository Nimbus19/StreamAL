...
STREAMAL_EXPORT uint64_t iAudioUnitQueue(struct iAudioUnit* audioUnit, uint64_t now, uint64_t timestamp, uint64_t offset, const void* buffer, size_t bufferSize);
